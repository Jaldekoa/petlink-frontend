    ...
    <section className="mt-stack-sm mb-stack-md pt-6">
      ...
      <div className="relative group mt-3">
        <input
          ...
          placeholder="Busca razas, nombres o lugares..."
          type="text"
          value={value}
          onChange={(e) => onChange(e.target.value)}
        />
        <span className="material-symbols-outlined absolute left-5 top-1/2 -translate-y-1/2 text-primary text-2xl group-focus-within:text-secondary-fixed-dim">
          search
        </span>
      </div>
    </section>
