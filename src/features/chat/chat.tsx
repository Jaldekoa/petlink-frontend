...
export default function Chat() {
  return (
    <>
        ...
        <div className="flex justify-between items-center px-margin-mobile py-base h-16 w-full max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <img
                alt="Protectora La Esperanza Profile"
            ...
            <div>
              <h1 className="font-label-md text-label-md text-on-surface">
                Protectora La Esperanza
              </h1>
      ...
      <main className="mt-20 pt-10 px-margin-mobile max-w-7xl mx-auto space-y-stack-lg">
        <HeroAnimal />
