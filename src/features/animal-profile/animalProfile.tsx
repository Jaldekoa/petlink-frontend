...
export default function AnimalProfile({
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-50 bg-surface/90 backdrop-blur-md">
        <div className="flex justify-between items-center px-margin-mobile py-base h-16 w-full max-w-7xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-headline-md text-primary font-extrabold tracking-tight">
              Petlink
            </h1>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button className="material-symbols-outlined text-primary hover:bg-surface-container-high rounded-full p-2 transition-colors active:scale-90">
              share
            </button>
          </div>
        </div>
        ...
        <section className="relative px-margin-mobile pt-12 overflow-visible">
          <div className="relative bg-secondary-container rounded-3xl h-80 w-full flex items-end justify-center">
            ...
            <div className="absolute -top-16 w-full flex justify-center">
              <img
                className="z-10 w-70 md:w-90 h-auto pop-out-shadow transform transition-transform duration-500 hover:scale-105"
        ...
        <div className="px-margin-mobile mt-base">
          ...
          <div className="flex flex-wrap gap-stack-sm mb-stack-lg">
            <div className="flex items-center gap-2 bg-secondary-container/50 px-4 py-2 rounded-full text-on-secondary-fixed-variant">
              ...
              <span className="font-label-md text-label-md">{energy}</span>
            </div>
            <div className="flex items-center gap-2 bg-secondary-container/50 px-4 py-2 rounded-full text-on-secondary-fixed-variant">
              <span className="material-symbols-outlined text-lg">
                vaccines
              </span>
              <span className="font-label-md text-label-md">{featureOne}</span>
            </div>
            <div className="flex items-center gap-2 bg-secondary-container/50 px-4 py-2 rounded-full text-on-secondary-fixed-variant">
            ...
            <div className="flex items-center gap-2 bg-secondary-container/50 px-4 py-2 rounded-full text-on-secondary-fixed-variant">
              ...
              <span className="font-label-md text-label-md">{featureTwo}</span>
            </div>
          </div>
          {/*<!-- About Section -->*/}
